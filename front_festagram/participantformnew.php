...
<div class="row">
    ...
    <h1>Festagram Participation Registration Form.</h1>
    <div class="container">
    <!-- form begins -->
        <form action="" method="post">
        <h1>Fill in the details to get your Festagram participation Id</h1>
...
<button type="submit" name="sub" class="button-contact">Submit</button>
    ...
    if(isset($_POST["sub"]))
    {
        ...
        {
            //insertion query - including all required fields
            $query="insert into participants (fname,mname,lname,gender,course,emailid,pnumber,cname,ccity,cstate,password,vkey,verified) VALUES ('$fname','$mname','$lname','$gender','$course','$email','$pnumber','$cname','$ccity','$cstate','$password','',0)";
            ...
            if($new_id > 0) {
                echo "<h3 style='color:green; text-align:center; margin:20px; padding:15px; background:#d4edda; border:2px solid #28a745; border-radius:5px;'>Registration Successful!<br><br>Your participant ID is: <strong style='font-size:24px; color:#155724;'>$new_id</strong></h3>";
            } else {
                // Fallback: query for the ID using email
                ...
                if(!$result2)
                {
                    ...
                    {   
                        echo "<h3 style='color:green; text-align:center; margin:20px; padding:15px; background:#d4edda; border:2px solid #28a745; border-radius:5px;'>Registration Successful!<br><br>Your participant ID is: <strong style='font-size:24px; color:#155724;'>".$row["p_id"]."</strong></h3>";
                    }
                }
            }
        } else {
