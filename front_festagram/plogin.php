...
<html lang="en">
  <head>
    ...
    <title>Festagram Participant Login</title>
...
<div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <!-- ilove festagram text -->
      <div class="fadeIn first">
        <div style="text-align: center; padding: 20px; font-size: 48px; color: #333; font-weight: bold;">
          I ❤️ <span style="color: #007bff;">Festagram</span>
        </div>
      </div>
  
      <!-- Login Form -->
      <form action="" method="POST">
	  <h5>Festagram Participant Login</h5>
